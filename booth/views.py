...
def search_results(request):
    ...
    if 'category' in request.GET and request.GET["category"]:
        ...
        message = f"{parameter}"
        return render(request, 'categories/search.html',{"message":message,"category": img, "all_locations": all_locations,"all_categories":all_categories})

    else:
        message = "You haven't searched for any image category"
        return render(request, 'categories/search.html',{"message":message, "all_categories":all_categories, "all_locations": all_locations})
